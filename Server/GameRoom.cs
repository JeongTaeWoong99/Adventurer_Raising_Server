...
{ 
	...
	public class GameRoom : IJobQueue
	{
		...
		public void EntityInfoChange(CommonSession session)
		{
		...
		// 세션 목록 접근자 추가
		public List<CommonSession> GetCommonSessions() => _commonSessions;
		...
		/// </summary>
		public void ScheduleDeathAndRespawn(CommonSession deadSession)
		{
			// 플레이어 제외
